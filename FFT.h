 ...
 *
 *@param input - pointer to source array.
 *@param output - pointer to target array.
 *@param bits - length of binary representation of numbers.
 *
 ...
 *
 *@param input - pointer to array of values for which DFT will be calculated.
 *@param output - pointer to array where output of DFT will be stored.
 *@param bits - length of binary representation of numbers.
 *
 *@return 0 on success, otherwise -1.
 *
 ...
 *
 *@param input - pointer to pointer to array where values for which DFT will be caluculated.
 *@param output - pointer to pointer to array where output of DFT will be stored.
 *@param bits - length of binary representation of numbers.
 *
 *@return 0 on success, otherwise -1.
 *
